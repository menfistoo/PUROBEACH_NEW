...
from .room_changes_log import migrate_room_changes_table
...
MIGRATIONS = [
    ...
    # Phase 21: Room change history (visual info for staff)
    ('room_changes_table', migrate_room_changes_table),
]
